function runDispenser() {
    ...
    switch (Number(choice)) {
        ...
        case 5:
            ...
            break;
        case 6:
            console.log("Decending sorted frequency: " + sortChocolateBasedOnCount(chocolates));
            break;
        case 7:
        ...
        case 8:
            ...
            if (typeof (returnArr) === 'string')
                ...
                console.log(finalColor + " chocolates: " + returnArr[0] + " changed");
                chocolates = returnArr[1];
            }
            break;
        case 9:
            var color = prompt("Color to be removed");
            console.log("Chocolate removed: " + color);
            chocolates = removeChocolateOfColor(chocolates, color);
            break;
        case 10:
            var number = prompt("Chocolates to dispense");
            console.log("Rainbow chocolates dispensed on " + number +" is: "+ dispenseRainbowChocolates(chocolates, number));
            break;
    }
    console.log(chocolates);
